...
registerOnClick('sphere black', false, false, [0,1,2], function() {
  assignMat('metal_stand', 'paint black');
}, function() {});
registerOnClick('sphere chrome', false, false, [0,1,2], function() {
  assignMat('metal_stand', 'chrome');
}, function() {});
registerOnClick('sphere white', false, false, [0,1,2], function() {
  assignMat('metal_stand', 'paint white');
}, function() {});

registerOnClick('slab 01', false, false, [0,1,2], function() {
  replaceTexture('wood material 0', 'wood_basecolor_1.jpg.001', 'wood_basecolor_1.jpg', function() {});
}, function() {});

registerOnClick('slab 02', false, false, [0,1,2], function() {
  replaceTexture('wood material 0', 'wood_basecolor_1.jpg.001', 'wood_basecolor_2.jpg', function() {});
}, function() {});

registerOnClick('slab 03', false, false, [0,1,2], function() {
  replaceTexture('wood material 0', 'wood_basecolor_1.jpg.001', 'wood_basecolor_3.jpg', function() {});
}, function() {});
